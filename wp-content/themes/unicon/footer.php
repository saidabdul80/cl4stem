<?php global $minti_data; ?>
		...
		<div class="container">
			...
			<div class="sixteen columns">
				...
				<div class="copyright-text copyright-col1">
					...
					<?php } else { ?>
						&copy; <?php _e('Copyright', 'unicon') ?> <?php echo esc_html(date("Y ")); esc_html(bloginfo('name')); ?>
					<?php } ?>
				</div>
	...
	<?php } ?>
	<div style="position: fixed; bottom: 5px; left: 5px; z-index:1000;top:35vh;"><?php echo do_shortcode('[DISPLAY_ULTIMATE_SOCIAL_ICONS]'); ?></div>
<style>
