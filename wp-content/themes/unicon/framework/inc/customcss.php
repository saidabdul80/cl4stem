...
if ( !function_exists( 'minti_dynamic_css' ) ) {
	...
	function minti_dynamic_css() {
		...
		$usercss_xl = $usercss_l = $usercss_m = $usercss_s = $usercss_xs = '';

		if(isset($minti_data['textarea_csscode_xl']) && $minti_data['textarea_csscode_xl'] != '') { $usercss_xl = balancetags($minti_data['textarea_csscode_xl']); }
		if(isset($minti_data['textarea_csscode_l']) && $minti_data['textarea_csscode_l'] != '') { $usercss_l = balancetags($minti_data['textarea_csscode_l']); }
		if(isset($minti_data['textarea_csscode_m']) && $minti_data['textarea_csscode_m'] != '') { $usercss_m = balancetags($minti_data['textarea_csscode_m']); }
		if(isset($minti_data['textarea_csscode_s']) && $minti_data['textarea_csscode_s'] != '') { $usercss_s = balancetags($minti_data['textarea_csscode_s']); }
		if(isset($minti_data['textarea_csscode_xs']) && $minti_data['textarea_csscode_xs'] != '') { $usercss_xs = balancetags($minti_data['textarea_csscode_xs']); }
		...
		.commentlist li.bypostauthor .comment-text{border-color: {$color_accent};}
		...
		// $css_output_escaped = "<style type=\"text/css\">\n" . $custom_css . "\n</style>";
		// if( !empty($custom_css) ) {
		// 	echo $css_output_escaped; // WPCS: xss ok. Everything in $css_output_escaped has already been escaped above.
		// }

		// Output CSS minified on front end
		if( !empty($custom_css) ) {
			echo "<style type=\"text/css\">\n" . minti_minify_css($custom_css) . "\n</style>";
		}
