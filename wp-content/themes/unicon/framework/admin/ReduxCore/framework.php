        ...
        class ReduxFramework {
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( ! empty ( $this->args['opt_name'] ) ) {
                    ...
                    // Admin Bar menu
                    // modified by minti: Removed admin bar
                    ...
                    if ( $this->args['database'] == "network" && $this->args['network_admin'] ) {
                        ...
                        // modified by minti: Removed Action for Network Admin Bar
                    }
                    // Ajax saving!!!
            ...
            public function vc_fixes() {
                if ( redux_helpers::isFieldInUse( $this, 'ace_editor' ) ) {
                    ...
                    //wp_deregister_script( 'wpb_ace' ); // Theme Check: Fixes conflicts with the the Ace Editor in Visual Composer.
                }
            }
...
//                    }
             ...
             * @return      void
             */
            // modified by minti: Removed Admin bar function
                    ...
                    if ( $this->args['async_typography'] && ! empty ( $this->typography ) ) {
                        ...
                        <script>
                            ...
                            (function() {
                                ...
                                wf.src = <?php echo "'" . get_template_directory_uri() . '/framework/admin/ReduxCore/assets/js/webfont.js' . "'"; ?>;
                        ...
                        $protocol = (is_ssl()) ? "https:" : "http:"; // modified by minti
