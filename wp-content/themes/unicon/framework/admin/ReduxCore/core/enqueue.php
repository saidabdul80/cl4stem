    ...
    if ( ! class_exists( 'reduxCoreEnqueue' ) ) {
        class reduxCoreEnqueue {
            ...
            private function register_styles() {
                ...
                wp_register_style(
                    'select2-css',
                    get_template_directory_uri() . '/framework/admin/extensions/vendor_support/vendor/select2/select2.css',
                    array(),
                    '3.5.2',
                    'all'
                );
            ...
            private function register_scripts() {
                ...
                wp_register_script(
                    'select2-js',
                    get_template_directory_uri() . '/framework/admin/extensions/vendor_support/vendor/select2/select2.min.js',
                ...
                wp_enqueue_script(
                    'webfontloader',
                    get_template_directory_uri() . '/framework/admin/ReduxCore/assets/js/webfont.js',
                    array( 'jquery' ),
                    '1.5.3',
                    true
                );
