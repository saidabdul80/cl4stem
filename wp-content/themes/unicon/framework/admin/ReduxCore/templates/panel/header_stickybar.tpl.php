...
<div id="redux-sticky">
    <div id="info_bar">
        ...
        <a href="javascript:void(0);" class="expand_options<?php echo esc_attr(( $this->parent->args['open_expanded'] ) ? ' expanded' : ''); ?>"<?php echo esc_html($this->parent->args['hide_expand']) ? ' style="display: none;"' : '' ?>>
