/* ------------------------------------------------------------------------ */
/* Simplified JS for basic plugin functionality
/* ------------------------------------------------------------------------ */
/*!
 * jquery.countTo()
...
jQuery(document).ready(function($){
    ...
    function portfolioIsotope(){
    	...
    	var $portfoliocontainer = $('.portfolio-items');
   		//$('.portfolio-item').css({visibility: "visible", opacity: "1"});
    ...
    $('.blog-item .blog-pic').hover(function() {
		...
		$(this).find('i').stop().animate({'margin-top' : '-33px', 'opacity' : 1}, 160);
	}, function(){
