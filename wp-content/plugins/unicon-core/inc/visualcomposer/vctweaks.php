	...
	vc_map( array(
		...
		'params' => array(
			...
			array(
				...
				"value" => array("Hide on Desktop" => 'hide'),
			),
			array(
				"type" => 'checkbox',
				//"heading" => "Tablet Visibility",
				"param_name" => "tablet_landscape_visibility",
				"value" => array("Hide on Tablet Landscape" => 'hide'),
			),
			array(
				"type" => 'checkbox',
				//"heading" => "Tablet Visibility",
				"param_name" => "tablet_portrait_visibility",
				"value" => array("Hide on Tablet Portrait" => 'hide'),
			),
			array(
				"type" => 'checkbox',
				//"heading" => "Mobile Landscape Visibility",
				"param_name" => "mobile_landscape_visibility",
				"value" => array("Hide on Mobile Landscape" => 'hide'),
			),
			array(
				"type" => 'checkbox',
				//"heading" => "Mobile Portrait Visibility",
				"param_name" => "mobile_portrait_visibility",
				"value" => array("Hide on Portrait" => 'hide'),
			),
		),
		'js_view' => 'VcRowView'
	));
