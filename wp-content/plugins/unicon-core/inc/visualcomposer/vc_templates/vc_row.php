...
extract(shortcode_atts(array(
	...
	'class' => '',
	'desktop_visibility' => '',
	'tablet_landscape_visibility' => '',
	'tablet_portrait_visibility' => '',
	'mobile_landscape_visibility' => '',
	'mobile_portrait_visibility' => '',), 
$atts));
...
if(!empty($desktop_visibility)) {
	$main_class .= ' minti-desktop-row-hide';
}
if(!empty($tablet_landscape_visibility)) {
	$main_class .= ' minti-tablet-landscape-row-hide';
}
if(!empty($tablet_portrait_visibility)) {
	$main_class .= ' minti-tablet-portrait-row-hide';
}
if(!empty($mobile_landscape_visibility)) {
	$main_class .= ' minti-mobile-landscape-row-hide';
}
if(!empty($mobile_portrait_visibility)) {
	$main_class .= ' minti-mobile-portrait-row-hide';
}
