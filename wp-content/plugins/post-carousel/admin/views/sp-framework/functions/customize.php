 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Panel_SP_PC' ) && class_exists( 'WP_Customize_Panel' ) ) {
	class WP_Customize_Panel_SP_PC extends WP_Customize_Panel {
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Section_SP_PC' ) && class_exists( 'WP_Customize_Section' ) ) {
	class WP_Customize_Section_SP_PC extends WP_Customize_Section {
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Control_SP_PC' ) && class_exists( 'WP_Customize_Control' ) ) {
	class WP_Customize_Control_SP_PC extends WP_Customize_Control {
		...
		public function render_content() {
			...
			SP_PC::field( $this->field, $this->value(), $this->unique, 'customize' );
